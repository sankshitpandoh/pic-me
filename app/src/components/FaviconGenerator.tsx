          ...
          <section aria-label="Options" className="space-y-4">
            ...
            <div className="rounded-xl ring-1 ring-slate-200 dark:ring-slate-800 bg-white/70 dark:bg-white/5 p-4 grid gap-4">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="px-3 py-1.5 rounded-md text-sm bg-slate-200 dark:bg-slate-800" onClick={toggleAll}>
              ...
              <div className="flex gap-2">
                <button disabled={!file || busy} className={clsx('px-3 py-2 rounded-md text-sm bg-slate-900 text-white dark:bg-slate-100 dark:text-slate-900 disabled:opacity-50 disabled:cursor-not-allowed')} onClick={generate}>
                  {busy ? 'Generating…' : 'Generate .ico'}
                </button>
                <button className="px-3 py-2 rounded-md text-sm bg-slate-200 dark:bg-slate-800" onClick={clearAll}>Clear</button>
              </div>
              ...
              <div className="rounded-2xl ring-1 ring-slate-200 dark:ring-slate-800 bg-white/70 dark:bg-white/5 overflow-hidden">
                <div className="p-4 flex items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800">
                  ...
                  <div className="flex items-center gap-2">
                    <button className="px-3 py-2 rounded-md text-sm bg-slate-200 dark:bg-slate-800" onClick={download}>Download</button>
                  </div>
                </div>
